...
namespace RestaurantOrderManagement
{
    public partial class TakeoutForm : Form
    {
        ...
        private DateTimePicker _pickupTimePicker;

        public TakeoutForm(OrderService orderService, MenuService menuService)
        {
        ...
        private Panel CreateLeftPanel()
        {
            ...
            var phoneNumberLabel = new Label { Text = "Phone Number:", Location = new Point(10, 55) };
            _phoneNumberTextBox = new TextBox { Location = new Point(120, 52), Width = 200 };

            var pickupTimeLabel = new Label { Text = "Pickup Time:", Location = new Point(10, 85) };
            _pickupTimePicker = new DateTimePicker 
            { 
            ...
            customerGroup.Controls.AddRange(new Control[] { 
                customerNameLabel, _customerNameTextBox, 
                phoneNumberLabel, _phoneNumberTextBox,
                pickupTimeLabel, _pickupTimePicker,
                newOrderButton 
            });
            ...
            _ordersListView.Columns.Add("Phone", 100);
            _ordersListView.Columns.Add("Pickup Time", 120);
        ...
        private void LoadOrders()
        {
            ...
            var takeoutOrders = _orderService.GetOrdersByType(OrderType.Takeout);
            ...
            foreach (var order in takeoutOrders)
            {
                ...
                item.SubItems.Add(order.EstimatedReadyTime?.ToString("MM/dd hh:mm tt") ?? "TBD");
        ...
        {
            if (string.IsNullOrWhiteSpace(_customerNameTextBox.Text) || string.IsNullOrWhiteSpace(_phoneNumberTextBox.Text))
            {
                MessageBox.Show("Please enter customer name and phone number.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void SubmitOrderButton_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show($"Takeout order #{_currentOrder.OrderId} submitted successfully!\nCustomer: {_currentOrder.CustomerName}\nPhone: {_currentOrder.PhoneNumber}", 
